...
def convert_pixel_to_world(x_pixel, y_pixel):
    # 像素坐标
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    # 转换中心点坐标到世界坐标
                    world_coords = convert_pixel_to_world(x_center, y_center)
                    # 输出世界坐标
...
# 命令使用
# python modified_detect.py --weights runs/train/exp11/weights/best.pt --source  data/images/video404.jpg # webcam
